					...
					<div class="tab-content">
							...
							<div class="list-group list-group-flush ">
								...
								<div class="list-group-item d-flex  align-items-center">
									<div class="ml-3">
										...
										data-image-src="{{asset('template-assets/valex/img/faces/6.jpg')}}"><span class="avatar-status bg-success"></span></span>
								...
								<div class="list-group-item d-flex  align-items-center">
									<div class="ml-3">
										<span class="avatar avatar-lg brround cover-image" data-image-src="{{asset('template-assets/valex/img/faces/9.jpg')}}"><span class="avatar-status bg-success"></span></span>
									</div>
									<div>
						...
						<div class="tab-pane  " id="side3">
							<div class="list-group list-group-flush ">
								<div class="list-group-item d-flex  align-items-center">
									<div class="ml-2">
										<span class="avatar avatar-md brround cover-image" data-image-src="{{asset('template-assets/valex/img/faces/9.jpg')}}"><span class="avatar-status bg-success"></span></span>
									</div>
									<div class="">
								...
								<div class="list-group-item d-flex  align-items-center">
									<div class="ml-2">
										...
										data-image-src="{{asset('template-assets/valex/img/faces/9.jpg')}}"></span>
