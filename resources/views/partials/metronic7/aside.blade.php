            ...
            <ul class="menu-nav ">
                ...
                <ul class="menu-nav py-0">  
                    <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover"><a
                            ...
                            </span><span class="menu-text">{{ __('customTrans.stars and writers') }}</span><i
                            ...
                            <ul class="menu-subnav">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item mt-2 " aria-haspopup="true"><a
                                            href="{{ route('stars.create') }}" class="menu-link "><i
                                                class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                class="menu-text">{{ __('customTrans.add new') }}</span></a>
                                    </li>

                                    <li class="menu-item mt-2 " aria-haspopup="true"><a
                                            href="{{ route('stars.index') }}" class="menu-link "><i
                                                class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                class="menu-text">{{ __('customTrans.stars list') }}</span></a>
                                    </li>
                ...
                <ul class="menu-nav py-0">
                    ...
                    <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover"><a
                            ...
                            </span><span class="menu-text">{{ __('customTrans.programs') }}</span><i
                                class="menu-arrow"></i></a>
                        <div class="menu-submenu "><i class="menu-arrow"></i>
                            ...
                            <ul class="menu-subnav">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item mt-2 " aria-haspopup="true"><a
                                            href="{{ route('programs.create') }}" class="menu-link "><i
                                                class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                class="menu-text">{{ __('customTrans.add program') }}</span></a>
                                    </li>

                                    <li class="menu-item mt-2 " aria-haspopup="true"><a
                                            href="{{ route('programs.index') }}" class="menu-link "><i
                                                class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                class="menu-text">{{ __('customTrans.programs list') }}</span></a>
                                    </li>
                ...
                <ul class="menu-nav py-0">
                    ...
                    <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover"><a
                            ...
                            </span><span class="menu-text">{{ __('customTrans.episodes') }}</span><i
                                class="menu-arrow"></i></a>
                        <div class="menu-submenu "><i class="menu-arrow"></i>
                            ...
                            <ul class="menu-subnav">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item mt-2 " aria-haspopup="true"><a
                                            href="{{ route('program.episodes.create') }}" class="menu-link "><i
                                                class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                class="menu-text">{{ __('customTrans.add episode') }}</span></a>
                                    </li>

                                    <li class="menu-item mt-2 " aria-haspopup="true"><a
                                            href="{{ route('program.episodes.index') }}" class="menu-link "><i
                                                class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                class="menu-text">{{ __('customTrans.episodes list') }}</span></a>
                                    </li>
                    ...
                    <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover"><a
                            ...
                            </span><span class="menu-text">{{ __('customTrans.advisories') }}</span><i
                                class="menu-arrow"></i></a>
                        <div class="menu-submenu "><i class="menu-arrow"></i>
                            ...
                            <ul class="menu-subnav">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item mt-2 " aria-haspopup="true"><a
                                            href="{{ route('advisories.create') }}" class="menu-link "><i
                                                class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                class="menu-text">{{ __('customTrans.add advisory') }}</span></a>
                                    </li>

                                    <li class="menu-item mt-2 " aria-haspopup="true"><a
                                            href="{{ route('advisories.index') }}" class="menu-link "><i
                                                class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                class="menu-text">{{ __('customTrans.advisories list') }}</span></a>
                                    </li>
                ...
                <ul class="menu-nav py-0">
                    ...
                    <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover"><a
                            ...
                            </span><span class="menu-text">{{ __('customTrans.library') }}</span><i
                                class="menu-arrow"></i></a>
                        <div class="menu-submenu "><i class="menu-arrow"></i>
                            ...
                            <ul class="menu-subnav">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item mt-2 " aria-haspopup="true"><a
                                            href="{{ route('library.create') }}" class="menu-link "><i
                                                class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                class="menu-text">{{ __('customTrans.add book') }}</span></a>
                                    </li>

                                    <li class="menu-item mt-2 " aria-haspopup="true"><a
                                            href="{{ route('library.index') }}" class="menu-link "><i
                                                class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                class="menu-text">{{ __('customTrans.books list') }}</span></a>
                                    </li>
                            ...
                            <ul class="menu-nav py-0">
                                ...
                                <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover"><a
                                        ...
                                        </span><span class="menu-text">{{ __('customTrans.reels') }}</span><i
                                            class="menu-arrow"></i></a>
                                    <div class="menu-submenu "><i class="menu-arrow"></i>
                                        ...
                                        <ul class="menu-subnav">
                                            ...
                                            <ul class="menu-subnav">
                                                ...
                                                <li class="menu-item mt-2 " aria-haspopup="true"><a
                                                        href="{{ route('reels.create') }}" class="menu-link "><i
                                                            class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                            class="menu-text">{{ __('customTrans.add reels') }}</span></a>
                                                </li>
            
                                                <li class="menu-item mt-2 " aria-haspopup="true"><a
                                                        href="{{ route('reels.index') }}" class="menu-link "><i
                                                            class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                            class="menu-text">{{ __('customTrans.reels list') }}</span></a>
                                                </li>
                ...
                {{-- <ul class="menu-nav py-0">
                    ...
                    <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover"><a
                            ...
                            </span><span class="menu-text">{{ __('customTrans.website content') }}</span><i
                                class="menu-arrow"></i></a>
                        <div class="menu-submenu "><i class="menu-arrow"></i>
                            ...
                            <ul class="menu-subnav">
                                ...
                                <li class="menu-item  menu-item-submenu" aria-haspopup="true"
                                    data-menu-toggle="hover"><a href="javascript:;" class="menu-link menu-toggle"><i
                                            ...
                                            class="menu-text">{{ __('customTrans.media programs') }}</span><span
                                            class="menu-label">
                        ...
                        <div class="menu-submenu "><i class="menu-arrow"></i>
                            ...
                            @can('ability.all.resource')
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item mt-2 " aria-haspopup="true"><a
                                            href="{{ route('ability.index') }}" class="menu-link "><i
                                                class="menu-bullet menu-bullet-dot"><span></span></i><span
