{{-- <div>
    ...
    <div class="card card-custom border ">
        ...
        <div class="card-body row align-items-center justify-content-between ">
            ...
            <x-input type="number" min="1" wire:model='paper_count' name='paper_count' label divWidth='2'></x-input>
    ...
    <div class="card card-custom border">
        ...
        <div class="card-body  ">
            ...
            <div>
                ...
                <x-filepond::upload wire:model.live="book_attchment" name="book_attchment" required='true' allowFileSizeValidation
                    maxFileSize='102400KB' class="@error('book_attchment') is-invalid   @enderror m-5 " />
...
<div>
    @include('livewire.dashboard.libraries.library-form',['type'=>'store'])
</div>