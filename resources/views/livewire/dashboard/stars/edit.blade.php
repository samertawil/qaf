<div>
    ...
    <div class="card card-custom border">
        ...
        <div class="card-body row ">
            <x-select wire:model='name_title_id' name="name_title_id" :options="$this->titleNames->pluck('status_name', 'id')" label divWidth='2'></x-select>
            ...
            <x-select wire:model='star_type_id' name='star_type_id' :options="$this->starTypes->pluck('status_name', 'id')" label divWidth='2'></x-select>
        ...
        <div>
            ...
            @if ($s_image_preview)
                <div class="" style="height: 250px; width: 250px; margin-top:10px; margin:auto"
                    ...
                    <a href="{{ asset('storage/' . $s_image_preview) }}" target="_blank">
                        <img src="{{ asset('storage/' . $s_image_preview) }}"
    ...
    <div class="modal-footer " style="border-top:none;">
        ...
        <x-button label="edit" wire:click.prevent='update' default_class="btn ripple btn-primary" data-dismiss="modal"
