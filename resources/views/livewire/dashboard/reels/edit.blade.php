{{-- <div>
    ...
    <div class="card card-custom border">
        ...
        <div class="card-body row align-items-center ">
            ...
            <x-input wire:model='reel_title' name='reel_title' label divWidth='4'></x-input>
...
<div>
    {{-- <livewire:livewire.reels.reel-form></livewire:livewire.reels.reel-form> --}}
    @include('livewire.dashboard.reels.reel-form',['type'=>'update'])
 </div>
