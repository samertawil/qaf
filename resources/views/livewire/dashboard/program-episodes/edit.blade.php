<div>
    ...
    <div class="card card-custom border">
        ...
        <div class="card-body row justify-content-between">
            ...
            <x-input wire:model='url' name='url' label divWidth='7'></x-input>
            ...
            <x-textarea wire:model='e_note' name='notes' label divWidth='6' rows="4"></x-textarea>
    ...
    <div class="modal-footer " style="border-top:none;">
        ...
        <x-button wire:click.prevent='update' label="edit" default_class="btn ripple btn-primary" data-dismiss="modal"
