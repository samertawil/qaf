                ...
                <div class="col-12">
                    <div class="swiper">
                        ...
                        <div class="swiper-wrapper">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="swiper-slide">

                                    <div>
                                        <img src="<?php echo e(asset('storage/' . $slide->cover_image)); ?>">

                                        <div class="over">
                                            <h4><?php echo e($slide->hot_feed ?? $slide->name); ?></h4>
                                            <p>
                                                <?php echo e($slide->hot_description ?? $slide->title); ?>

                                            </p>
                                            <a href="<?php echo e($slide->url); ?>" target="_blank" class="btnFill"> شاهد 
                                            </a>
                                        </div>
                                    </div>
...
<?php /**PATH C:\xampp\htdocs\qaf\project-qaf-admin\resources\views/livewire/website/index-sections/master-slider.blade.php ENDPATH**/ ?>